...
import com.manyong.datatransmit.myutil.Jumin;
...
public class ResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tv_tti = (TextView) findViewById(R.id.tv_tti);
        TextView tv_gender = (TextView) findViewById(R.id.tv_gender);
        TextView tv_local = (TextView) findViewById(R.id.tv_local);
        TextView tv_ganji = (TextView) findViewById(R.id.tv_ganji);
        TextView tv_season = (TextView) findViewById(R.id.tv_season);
